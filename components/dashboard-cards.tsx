    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Out of 100 managers</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <CardContent>
          <div className="text-2xl font-bold">$100.5m</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">Fri, 20 Apr</div>
          <p className="text-xs text-muted-foreground">19:00 UTC</p>
        </CardContent>
      </Card>
    </div>
  )
